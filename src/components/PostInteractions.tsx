...
import { likeAction, rePostAction, saveAction } from "@/actions";
  ...
  return (
    <div className="flex items-center justify-between gap-4 lg:gap-16 my-2 text-textGray">
        ...
        <form className="">
          <button className="flex items-center gap-2 cursor-pointer group">
            ...
            <span
              ...
              group-hover:text-iconBlue text-sm`}
            >
              {count?.comments}
            </span>
          </button>
      ...
      <div className="flex items-center gap-2">
        <form action={bookmarkPost} className="cursor-pointer group">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
